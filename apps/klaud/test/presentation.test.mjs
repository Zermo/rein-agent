...
test("run settings use a dedicated strict route rather than shell preferences", () => {
  ...
  for (const value of [{}, { bashApproval: true }, { bashApproval: "forever" }, { reasoningEffort: "maximum" }, { reasoningEffort: "high", headers: {} }, { key: "bashApproval", value: "auto" }, { reasoningControl: {} }]) assert.throws(() => requestRoute("saveRunSettings", value));
